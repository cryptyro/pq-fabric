...
PeerOrgs:
  ...
  - Name: Org1
    ...
    #    PublicKeyAlgorithm: ecdsa # CA's key algorithm ("ecdsa" or "ed25519" or "xdsa")
    ...
    #                     - {{ .CommonName }}
    #                     - {{ .Hostname }}
    #   PublicKeyAlgorithm: Nodes' key algorithm ("ecdsa" or "ed25519" or "xdsa")
    # ---------------------------------------------------------------------------
    # Specs:
    ...
    #
    # PublicKeyAlgorithm: Hosts' key algorithm ("ecdsa" or "ed25519" or "xdsa")
    #
    ...
    # PublicKeyAlgorithm: Users' key algorithm ("ecdsa" or "ed25519" or "xdsa")
    # ---------------------------------------------------------------------------
    Users:
      Count: 1
      PublicKeyAlgorithm: "ecdsa"
...
func renderNodeSpec(domain string, spec *NodeSpec) error {
	...
	if spec.PublicKeyAlgorithm == "" {
		spec.PublicKeyAlgorithm = EDMLDSA
	}
