...
func NewWithParams(securityLevel int, hashFamily string, keyStore bccsp.KeyStore) (bccsp.BCCSP, error) {
	...
	swbccsp.AddWrapper(reflect.TypeOf(&xdsaPrivateKey{}), &xdsaSigner{})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&xdsaPrivateKey{}), &xdsaPrivateKeyVerifier{})
	swbccsp.AddWrapper(reflect.TypeOf(&xdsaPublicKey{}), &xdsaPublicKeyKeyVerifier{})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.XDSAKeyGenOpts{}), &xdsaKeyGenerator{})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.XDSAPrivateKeyImportOpts{}), &xdsaPrivateKeyImportOptsKeyImporter{})
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.XDSAGoPublicKeyImportOpts{}), &xdsaGoPublicKeyImportOptsKeyImporter{})
