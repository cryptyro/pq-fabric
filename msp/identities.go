...
func (id *identity) Verify(msg []byte, sig []byte) error {
	...
	if (id.cert.PublicKeyAlgorithm != x509.Ed25519) && (id.cert.PublicKeyAlgorithm != x509.EDMLDSA) {
...
func (id *signingidentity) Sign(msg []byte) ([]byte, error) {
	...
	// but golang requires the hash for ecdsa and requires
	// the full message for ed25519
	if (id.identity.cert.PublicKeyAlgorithm != x509.Ed25519) && (id.identity.cert.PublicKeyAlgorithm != x509.EDMLDSA) {
		hashOpt, err := id.getHashOpt(id.msp.cryptoConfig.SignatureHashFamily)
		if err != nil {
			return nil, errors.WithMessage(err, "failed getting hash function options")
		}
